...
import br.com.tiagohs.popmovies.view.callbacks.PerfilEditCallbacks;
import butterknife.BindView;


public class PerfilEditFragment extends BaseFragment implements PerfilEditView {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mPresenter.setUsername(PrefsUtils.getCurrentProfile(getContext()).getUser().getUsername());
